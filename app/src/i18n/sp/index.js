...
export default {
  ...
  index: {
    only_id: 'Código de software',
    only_title: 'Necesita verificar el código del software',
    only_message: '<p><span class="text-red">Vaya a: https://po.56yhz.com</span></p> <p><em>Verifique lo que encontró en la configuración del software El código del software</em></p>',
  ...
  Settings: {
    ...
    only_id: 'etiqueta del dispositivo',
  },
  menuItem: {
    dashboard: 'Tablero',
    inbound: 'Entrante',
  ...
  notice: {
    ...
    mobile_dn: {
      ...
      notice16: 'La cantidad seleccionada debe ser mayor que 0'
    },
    mobile_goodsstock: {
    ...
    version: {
      new: 'Actualización de nueva versión',
      detail: 'Vaya al sitio web oficial de GreaterWMS, https://www.56yhz.com/, para descargar la última versión de la APLICACIÓN'
    },
