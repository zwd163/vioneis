...
export default {
  ...
  index: {
    only_id: 'ソフトウェア コード',
    only_title: 'ソフトウェア コードを確認する必要があります',
    only_message: '<p><span class="text-red">次の場所に移動します: https://po.56yhz.com</span></p> <p><em>ソフトウェア設定で見つかった内容を確認してくださいソフトウェア コード</em></p>',
    app_title: 'アプリのタイトル',
    slogan: 'スローガン',
    server: 'リクエストアドレス',
  ...
  notice: {
    ...
    mobile_dn: {
      ...
      notice14: 'ロケーション名:',
      notice15: 'ピッキングする数量:',
      notice16: 'ピック数は 0 より大きくなければなりません'
    },
    mobile_goodsstock: {
      notice1: '在庫リスト',
